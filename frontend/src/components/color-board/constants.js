...
export const PREVIEW_MEDIA_MAX_HEIGHT = 360;
export const PREVIEW_CHROME_HEIGHT = 64;

export const BOARD_CARD_QUALITY = 'low';
export const BOARD_PREVIEW_QUALITY = 'normal';
